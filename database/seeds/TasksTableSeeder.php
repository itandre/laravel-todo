...
class TasksTableSeeder extends Seeder
{
    ...
    public function run()
    {
      ...
      $tasks = array(
        ...
        ['id' => 5, 'name' => 'Task 5', 'slug' => 'task-5', 'project_id' => 2, 'completed' => true, 'description' => 'My fifth task.', 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['id' => 6, 'name' => 'Task 6', 'slug' => 'task-6', 'project_id' => 2, 'completed' => false, 'description' => 'My sixth task.', 'created_at' => new DateTime, 'updated_at' => new DateTime],
        ['id' => 7, 'name' => 'Task 7', 'slug' => 'task-7', 'project_id' => 3, 'completed' => true, 'description' => 'My seventh task.', 'created_at' => new DateTime, 'updated_at' => new DateTime]
      );
